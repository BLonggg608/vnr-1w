export const sidebarItems = [
  { id: "1", title: "I. MỞ ĐẦU" },
  { id: "2", title: "II. NHỮNG YẾU TỐ TẠO NÊN THỜI CƠ" },
...
export const khaiQuatData = {
  general: [
    ...
    "Về khái quát, Cách mạng Tháng Tám diễn ra vào tháng 8 năm 1945, dưới sự lãnh đạo của Đảng Cộng sản Đông Dương. Chỉ trong một thời gian rất ngắn:",
  ],
  generalDetails: [
  ...
  milestones: [
    {
      time: "19/8/1945",
      content:
        "Nhân dân Hà Nội đứng lên giành chính quyền, mở đầu cho làn sóng tổng khởi nghĩa trên cả nước.",
    },
    {
      time: "23/8/1945",
      content:
        "Chính quyền được giành ở Huế – trung tâm của triều đình phong kiến.",
    },
    {
      time: "25/8/1945",
    ...
    },
    {
      time: "2/9/1945",
      content:
        "Tại Quảng trường Ba Đình, Chủ tịch Hồ Chí Minh đã đọc Tuyên ngôn Độc lập.",
    },
  ],
  conclusions: [
